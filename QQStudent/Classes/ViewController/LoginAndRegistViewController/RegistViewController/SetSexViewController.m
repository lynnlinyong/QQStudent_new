...
- (void) initUI
{
    self.view.frame = [UIView fitCGRect:CGRectMake(0, 0, 240, 140)
                             isBackView:NO];
    ...
    cancelBtn.tag   = 1;
    cancelBtn.frame = CGRectMake(160, 100, 40, 30);
