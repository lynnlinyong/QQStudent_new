...
@property (nonatomic, strong, readonly) UIImageView *voiceValuesImgVew;
...
//		self.spinnerView.center = CGPointMake(ceil(CGRectGetWidth(self.hudView.bounds)/2)+0.5, ceil(self.hudView.bounds.size.height/2)+0.5);
        self.voiceValuesImgVew.center = CGPointMake(ceil(CGRectGetWidth(self.hudView.bounds)/2)+0.5, ceil(self.hudView.bounds.size.height/2)+0.5);
    }
}
...
- (void)registerNotifications {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(setVoiceLevelNotice:)
                                                 name:@"setVoiceLevelNotice"
                                               object:nil];
...
//        [self.voiceValuesImgVew startAnimating];
...
//        [self.voiceValuesImgVew stopAnimating];
...
- (UIImageView *) voiceValuesImgVew
{
    if (voiceValuesImgVew==nil)
    {
        voiceValuesImgVew = [[UIImageView alloc]init];
        voiceValuesImgVew.image = [UIImage imageNamed:@"record_animation1.png"];
        voiceValuesImgVew.frame = CGRectMake(0, 0, 40, 40);
    }
    
    [self.hudView addSubview:voiceValuesImgVew];
    
    return voiceValuesImgVew;
}
...
- (void) setVoiceLevelNotice:(NSNotification *) notice
{
    ...
    switch (level)
    {
        ...
        case SMALL_LEVEL:
        {
            voiceValuesImgVew.image = [UIImage imageNamed:@"record_animation2.png"];
            break;
        }
        case MID_LEVEL:
        {
            voiceValuesImgVew.image = [UIImage imageNamed:@"record_animation3.png"];
            break;
        }
        case HIGHT_LEVEL:
        {
            voiceValuesImgVew.image = [UIImage imageNamed:@"record_animation4.png"];
            break;
        }
        default:
            break;
