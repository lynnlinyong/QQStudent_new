...
- (void) initUI
{
    ...
    else
    {
        if (!iPhone5)
        {
            ...
            infoLab.frame = [UIView fitCGRect:CGRectMake(0, 0, 320, 30)
                                   isBackView:NO];
            navgBtn.frame = [UIView fitCGRect:CGRectMake(320-50-10, 5,
                                                         50, 20)
                                   isBackView:NO];
            bgView.frame = [UIView fitCGRect:CGRectMake(-2, 28,
                                                        self.view.frame.size.width+4,
                                                        self.view.frame.size.height)
                                  isBackView:NO];
            scrollView.frame = [UIView fitCGRect:CGRectMake(0, 32,
                                                            self.view.frame.size.width,
                                                            self.view.frame.size.height-20)
                                      isBackView:NO];
            botomLab.frame = [UIView fitCGRect:CGRectMake(0, 480-44-28,320, 20)
                                    isBackView:NO];
        ...
        else
        {
            ...
            navgBtn.frame = [UIView fitCGRect:CGRectMake(320-50-10, 5,
                                                         50, 20)
                                   isBackView:NO];
            bgView.frame = [UIView fitCGRect:CGRectMake(-2, 25,
                                                        self.view.frame.size.width+4,
                                                        self.view.frame.size.height)
                                  isBackView:NO];
            scrollView.frame = [UIView fitCGRect:CGRectMake(0, 28,
                                                            self.view.frame.size.width,
                                                            self.view.frame.size.height-20)
                                      isBackView:NO];
            botomLab.frame = [UIView fitCGRect:CGRectMake(0, 480-44-24,320, 20)
                                    isBackView:NO];
        }
    }
