...
- (void) initUI
{
    ...
    if ([[UIDevice currentDevice].systemVersion floatValue] >= 7)
    {
        if (iPhone5)
        {
            ...
            titleImgView.frame = [UIView fitCGRect:CGRectMake(self.view.frame.size.width/2-titleImg.size.width/2, 44+20,
                                                              titleImg.size.width, titleImg.size.height)
                                        isBackView:NO];
            orderTab.frame = [UIView fitCGRect:CGRectMake(self.view.frame.size.width/2-titleImg.size.width/2, titleImgView.frame.origin.y-5,
        ...
        else
        {
            ...
            titleImgView.frame = [UIView fitCGRect:CGRectMake(self.view.frame.size.width/2-titleImg.size.width/2, 44+20,
                                                              titleImg.size.width, titleImg.size.height)
                                        isBackView:NO];
            orderTab.frame = [UIView fitCGRect:CGRectMake(self.view.frame.size.width/2-titleImg.size.width/2, titleImgView.frame.origin.y+titleImgView.frame.size.height-10,
                                                          titleImg.size.width, 340)
                                    isBackView:NO];
            orderBtn.frame = [UIView fitCGRect:CGRectMake(160-img.size.width/2,
                                                          480-44-img.size.height,
    ...
    else
    {
        if (!iPhone5)
        {
            ...
            titleImgView.frame = [UIView fitCGRect:CGRectMake(self.view.frame.size.width/2-titleImg.size.width/2, 20,
                                                              titleImg.size.width, titleImg.size.height)
                                        isBackView:NO];
            orderTab.frame = [UIView fitCGRect:CGRectMake(self.view.frame.size.width/2-titleImg.size.width/2, titleImgView.frame.origin.y+titleImgView.frame.size.height,
                                                          titleImg.size.width, 340)
                                    isBackView:NO];
            orderBtn.frame = [UIView fitCGRect:CGRectMake(160-img.size.width/2,
                                                          480-54-img.size.height,
                                                          img.size.width,
                                                          img.size.height)
                                    isBackView:NO];
        }
